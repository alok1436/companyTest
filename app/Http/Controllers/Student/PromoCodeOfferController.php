...
use App\Affilate;
use App\SaleReport;
use App\PromoCodeOffer;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;
use Illuminate\Support\Facades\Mail;
use Illuminate\Support\Facades\Validator;

class PromoCodeOfferController extends Controller
{
    public const REDIRECT_URL = 'vendor/promoCodeOffers';

    public function index(Request $request)
    {
        $promoCodeOffers = PromoCodeOffer::get();
        return view('vendor.promoCodeOffers.index', compact('promoCodeOffers'));
    }
